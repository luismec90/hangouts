...
function renderData(groups) {
    ...
    if(!groups.length){
        ...
        $.each(groups, function (index, group) {
            ...
            table += "<tr> <td class='col-xs-2'>" + group.topic + "</td><td class='col-xs-5'><a href='" + group.url + "?gid=234021961885' target='_blank' class='link-group'> " + renderParticipants(group.participants) + " </a></td> <td class='col-xs-2'><a href='" + group.url + "?gid=234021961885' target='_blank' class='btn btn-primary'>Entrar</a></td></tr>"
        });
        table += '<table>';
