$(function () {
    ...
    loadGroups();
    $("body").on("click","#create-room,#create-room-2",function () {
...
function renderData(groups) {
    ...
    if(!groups.length){
        ...
        $.each(groups, function (index, group) {
            ...
            table += "<tr> <td class='col-xs-2'>" + group.topic + "</td><td class='col-xs-5'><a href='" + group.url + "?gid=514399285753' target='_blank' class='link-group'> " + renderParticipants(group.participants) + " </a></td> <td><a href='" + group.url + "?gid=514399285753' target='_blank' class='btn btn-primary'>Entrar</a></td></tr>"
        });
        table += '<table>';
